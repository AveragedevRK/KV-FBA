...
const DASHBOARD_MOCK_SHIPMENTS: Shipment[] = [
  ...
  { id: '6', shipmentId: 'SHP-6', name: 'S6', destination: 'D6', originWarehouse: 'W1', totalItems: 1200, carrier: 'Maersk', status: 'In Progress', createdDate: '2025-05-13T10:00:00', lastUpdated: '', items: [{ sku: 'LG-900', name: 'Gaming Monitor 27"', quantity: 1200, asin: 'B0LG900XXX' }] },
